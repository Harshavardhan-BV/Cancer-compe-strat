...
for case in cases:
    ...
    cf.eqratio_v_parm(df=df,plot_parm='Tpro_0',pre_path=pre_path,parm_name=parm_name,post_path=post_path,plot_Tpos=False)
    cf.eqratio_v_parm(df=df,plot_parm='Tp_initratio',pre_path=pre_path,parm_name=parm_name,post_path=post_path,plot_Tpos=False)
