...
for o2_lim in o2_lim_arr:
    df=pd.read_csv("../raw_output/EnvEq/pairwise/Tneg-Tpro/l_lim_o2Tpro-l_lim_o2Tneg/testindep-"+"{:.1f}".format(o2_lim[0])+"-"+"{:.1f}".format(o2_lim[1])+'.csv')
...
fig.savefig('../figures/EnvEq/pairwise/Tneg-Tpro/l_lim_o2Tpro-l_lim_o2Tneg/testindep-timeseries.svg')
...
df.to_csv('../analysed_data/EnvEq/pairwise/Tneg-Tpro/l_lim_o2Tpro-l_lim_o2Tneg/testindep-eq_values.csv',index=False)
...
fig.savefig('../figures/EnvEq/pairwise/Tneg-Tpro/l_lim_o2Tpro-l_lim_o2Tneg/testindep-eq-vs-lims.svg')
