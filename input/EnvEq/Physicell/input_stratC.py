...
#parameters based on strategy C in PhysiCell
...
lam_test=0.1 #(1/min)
#Growth rate
r_Tpos= 0.6*0.0432/60 #(/min)
r_Tpro= 0.6*0.0432/60 #(/min)
r_Tneg= 0.6*0.0432/60 #(/min)
#Death rate
...
##Oxygen
###T+
l_lim_o2Tpos=9 #lower-threshold(mmHg)
