...
def solve_parm(test_lim): #calls the solve_eq function with all default inputs other than o2_lim
    f_name_i=f_name+"{:.1f}".format(test_lim[0])+"-"+"{:.1f}".format(test_lim[1])
    lim[1,1]=test_lim
